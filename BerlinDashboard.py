...
def run():
    ...
    link = '[©Developed by Aanchal](https://www.linkedin.com/in/aanchal-mahajan-39a439190)'
...
st.write('''
    Dashboard created by [Aanchal](https://www.linkedin.com/in/aanchal-mahajan-39a439190), with [Streamlit](https://www.streamlit.io).
    See the code on [GitHub](https://github.com/aanchalmahajan3112/Covid-19-Dasboard-for-Berlin-City).
